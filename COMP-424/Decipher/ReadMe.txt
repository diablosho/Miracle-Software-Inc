================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : Decipher Project Overview
===============================================================================

The application wizard has created this Decipher application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Decipher application.
...
Decipher.h
    ...
    CDecipherApp application class.
...
res\Decipher.ico
    ...
    icon is included by the main resource file Decipher.rc.
...
DecipherDlg.h, DecipherDlg.cpp - the dialog
    These files contain your CDecipherDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in Decipher.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CDecipherDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named Decipher.pch and a precompiled types file named StdAfx.obj.
