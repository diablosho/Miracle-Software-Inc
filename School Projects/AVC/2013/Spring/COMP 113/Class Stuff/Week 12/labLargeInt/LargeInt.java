...
/////////////////////////////////////////////////////////
//	Write a method named isLargeIntZero
//		accepts a SpecializedList parameter
//		return type is boolean
//	Function: checks each node in the SpecializedList
//			  if all nodes are 0 then return true
//			  if any node contains a nonzero byte
//			  	return false
public static boolean isLargeIntZero(SpecializedList num)
{
	for (long i = 0; i < num.size(); i++)
	{
//		System.out.println("Bye" + num.currentFPos.info);
		if (num.currentFPos.info != 0)
			return false;
		num.getNextElement();
	}
	return true;
...
///////////////////////////////////////////////////////////////////////
// Create a method named multiply which handles LargeInt multiplication
// 		accepts two LargeInt parameters which will be multiplied
//		returns the product of the LargeInt parameters
public static LargeInt multiply(LargeInt first, LargeInt second)
{
	LargeInt one = new LargeInt("1");
	LargeInt mult = new LargeInt("0");
	...
	while (isLargeIntZero(second.numbers) == false)
	{
		mult = add (mult, first);
		second = subtract(second, one);
		second.numbers.resetForward();
//		System.out.println(one.numbers.currentFPos.info);
	}
return mult;
}
///////////////////////////////////////////////////////////////////////
