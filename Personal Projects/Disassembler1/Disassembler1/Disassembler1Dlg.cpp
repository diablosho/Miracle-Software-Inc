...
// Disassembler1Dlg.cpp : implementation file
//

#include "stdafx.h"
#include "Disassembler1.h"
#include "Disassembler1Dlg.h"
...
CDisassembler1Dlg::CDisassembler1Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDisassembler1Dlg::IDD, pParent)
	, BinaryDataSize(0)
...
void CDisassembler1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CDisassembler1Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BrowseForFile, &CDisassembler1Dlg::OnClickedBrowseforfile)
ON_WM_PAINT()
END_MESSAGE_MAP()


// CDisassembler1Dlg message handlers

BOOL CDisassembler1Dlg::OnInitDialog()
{
...
void CDisassembler1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CDisassembler1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CDisassembler1Dlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CDisassembler1Dlg::OnClickedBrowseforfile()
{
...
void CDisassembler1Dlg::ProcessFile()
{
...
void CDisassembler1Dlg::PopulateInstructionList(int TopIndex)
{
