	...
	, isEFLAGS(false)
{
	...
	Operands[0]=0x00000000;
	Operands[1]=0x00000000;
	Operands[2]=0x00000000;
...
{
	if (dbit && (Operands[1] != 0x00000000))						// Swap operands due to D-Bit in Opcode changing direction
	{
		DWORD temp = 0;
		temp = Operands[1];
