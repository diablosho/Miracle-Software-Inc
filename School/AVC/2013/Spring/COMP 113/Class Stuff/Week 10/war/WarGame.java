...
/******************************************************
 *	Devise and enter a simple shuffle method here
 *	Verify it worked by running 100 games
 *	with a maximum of 10000 battles / game
 ******************************************************/
        battle();
      }
...
Implement the queueShuffle method or call to queueShuffle
here. Each player's queue could be shuffled after a
certain number of battles (for example 26).
