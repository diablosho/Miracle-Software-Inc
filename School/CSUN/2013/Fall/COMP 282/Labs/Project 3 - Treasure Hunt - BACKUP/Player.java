...
public class Player extends Bot
{
	...
	public Player(JonesTreasurePath app, String name, String ID, Point start, Point end, Color colorValue)
	{
	...
	public Player(JonesTreasurePath app, String name, Waypoint startingWaypoint, Color colorValue)
	{
	...
	public void move()
	{
		...
		if (app.isGoldWaypoint(currentWaypoint))	
