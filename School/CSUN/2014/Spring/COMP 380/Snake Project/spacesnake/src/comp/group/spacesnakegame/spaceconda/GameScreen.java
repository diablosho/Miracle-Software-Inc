...
import comp.group.spacesnakegame.framework.Game;
import comp.group.spacesnakegame.framework.Graphics;
import comp.group.spacesnakegame.framework.Pixmap;
import comp.group.spacesnakegame.framework.Screen;
import comp.group.spacesnakegame.framework.Input.TouchEvent;
...
public class GameScreen extends Screen
{
	...
	private void drawWorld(	World world)
	{
		...
		Crystal stain = world.stain;
		
		Pixmap stainPixmap = null;
		if (stain.type == Crystal.TYPE_1) stainPixmap = Assets.stain1;
		if (stain.type == Crystal.TYPE_2) stainPixmap = Assets.stain2;
		if (stain.type == Crystal.TYPE_3) stainPixmap = Assets.stain3;
		int x = stain.x * 32;
		int y = stain.y * 32;
